...
Memory Game is an app that allows users to play a card matching game.  The game allows a selection of 3, 6, or 10 pairs of cards.
The user will match 2 like cards and if correct they will dissapear, and if incorrect they will flip back over.  
There is also a reset game button that will reset the game, replacing the cards and changing their values so that it isn't the same as before to prevent cheating.
...
<img src="project4.gif">

## Notes

Describe any challenges encountered while building the app:
  This project was much easier than the previous projects. 
